...
| Native check output | Observed command and result | Complete user acceptance or automatic freshness |
| Optional runner receipt | Command, exit, duration, source fingerprint | Complete user acceptance |
...
Only recorded operation produces helper receipts. Skill-only operation reports
observed checks in conversation and manually reevaluates changed inputs.
